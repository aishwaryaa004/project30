...
function setup() {
  ...
  //second level
  BlockPink1 = new BoxPink(201, 171, 20, 20);

  BlockPink2 = new BoxPink(220, 171, 20, 20);

  BlockPink3 = new BoxPink(240, 171, 20, 20);

  BlockPink4 = new BoxPink(260, 171, 20, 20);

  BlockPink5 = new BoxPink(280, 171, 20, 20);

  BlockPink6 = new BoxPink(300, 171, 20, 20);

  BlockPink7 = new BoxPink(320, 171, 20, 20);
